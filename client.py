...
class Client(Peer):
    ...
    def input_prompt(self):
        print('command list:')
        print(self.input_prompt_format.format(cmd='register' , prompt=''))
        print(self.input_prompt_format.format(cmd='listpeer', prompt=''))
        print(self.input_prompt_format.format(cmd='exit network', prompt=''))
        print(self.input_prompt_format.format(cmd='request [peername]', prompt=''))
        print(self.input_prompt_format.format(cmd='chat message [peername] [message]', prompt=''))
        print(self.input_prompt_format.format(cmd='list connected peer', prompt=''))
        print(self.input_prompt_format.format(cmd='help', prompt=''))
        print(self.input_prompt_format.format(cmd='disconnect', prompt=''))
        print(self.input_prompt_format.format(cmd='exit', prompt=''))
